...
## 课堂练习：JSX语法<div id="课堂练习：JSX语法"></div>
...
## 示例：React 组件<div id="示例：React组件"></div>
...
## 课堂练习：组件的参数<div id="课堂练习：组件的参数"></div>
